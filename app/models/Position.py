...
class Position(models.Model): 
    ...
    group = models.ForeignKey(Group, db_column="group", on_delete=models.CASCADE, null=True, blank=True)
    ...
    quantity = models.DecimalField(db_column="quantity", max_digits=13, decimal_places=3)
